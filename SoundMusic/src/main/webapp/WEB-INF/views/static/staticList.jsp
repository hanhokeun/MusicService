		  	...
		  	<div class="text-center" >
		  		<ul class="pagination justify-content-center">			
			  			...
			  			<c:if test="${PINFO.startPage ne 1}">
			  				<li class="page-item">
			  					<a class="page-item"href="../static/staticList.sm?nowPage=${PINFO.nowPage-1}&searchOption=${SEARCHOPTION}&keyword=${KEYWORD}">이전</a>
			  				</li>
			  			</c:if>
			  			<c:forEach var="page" begin="${PINFO.startPage}" end="${PINFO.endPage}">
			  				<li class="page-item">
			  					<a  class="page-link" href="../static/staticList.sm?nowPage=${page}&searchOption=${SEARCHOPTION}&keyword=${KEYWORD}">${page}</a>
			  				</li>
			  			</c:forEach>
				  			<%--다음링크 만들기--%>
					  	...
					  	<c:if test="${PINFO.endPage ne PINFO.totalPage}">
					  		<li class="page-item">
					  			<a class="page-link" href="../static/staticList.sm?nowPage=${PINFO.nowPage+1}&searchOption=${SEARCHOPTION}&keyword=${KEYWORD}">다음</a>
							</li>
						</c:if>
					</ul>
				</div>
